...
def check_project_status():
    ...
    print(
        "5. ✅ Improved Features - 10 features including margin-adjusted probabilities"
    )
    ...
    print(
        '     -d \'{"home_team": "Arsenal", "away_team": "Chelsea", "home_odds": 2.1, "draw_odds": 3.2, "away_odds": 3.5}\''
    )
